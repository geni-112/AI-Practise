...
description: Design, build, deploy, and validate governed chat-first big-data development workbenches on Huawei Cloud using FastAPI, LangGraph, Huawei MaaS/GLM, offline prompt templates, synthetic data, OBS, MRS Spark, DataArts, and optional DWS. Use when replacing or augmenting notebook-centric development with multi-agent vibe coding, defining prompt-to-contract-to-code workflows, creating Databricks-inspired three-stage workbench interfaces, planning Huawei Cloud resources, implementing review/security/lineage gates, or reproducing the SAT Agentic Data Workbench pattern.
---
...
- Adapt [assets/sat-business-prompt-template.md](assets/sat-business-prompt-template.md) for optional guided prompting and test cases.
